...
const _: () = {
    ["Size of tagRECT"][::core::mem::size_of::<tagRECT>() - 4usize];
    ["Alignment of tagRECT"][::core::mem::align_of::<tagRECT>() - 1usize];
    ["Offset of field: tagRECT::left"][::core::mem::offset_of!(tagRECT, left) - 0usize];
    ["Offset of field: tagRECT::top"][::core::mem::offset_of!(tagRECT, top) - 1usize];
    ["Offset of field: tagRECT::right"][::core::mem::offset_of!(tagRECT, right) - 2usize];
    ["Offset of field: tagRECT::bottom"][::core::mem::offset_of!(tagRECT, bottom) - 3usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of m65_dirent"][::core::mem::size_of::<m65_dirent>() - 268usize];
    ["Alignment of m65_dirent"][::core::mem::align_of::<m65_dirent>() - 1usize];
    ["Offset of field: m65_dirent::d_ino"][::core::mem::offset_of!(m65_dirent, d_ino) - 0usize];
    ["Offset of field: m65_dirent::d_off"][::core::mem::offset_of!(m65_dirent, d_off) - 4usize];
    ["Offset of field: m65_dirent::d_reclen"]
        [::core::mem::offset_of!(m65_dirent, d_reclen) - 6usize];
    ["Offset of field: m65_dirent::d_type"][::core::mem::offset_of!(m65_dirent, d_type) - 10usize];
    ["Offset of field: m65_dirent::d_name"][::core::mem::offset_of!(m65_dirent, d_name) - 12usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of dmagic_dmalist"][::core::mem::size_of::<dmagic_dmalist>() - 20usize];
    ["Alignment of dmagic_dmalist"][::core::mem::align_of::<dmagic_dmalist>() - 1usize];
    ["Offset of field: dmagic_dmalist::option_0b"]
        [::core::mem::offset_of!(dmagic_dmalist, option_0b) - 0usize];
    ["Offset of field: dmagic_dmalist::option_80"]
        [::core::mem::offset_of!(dmagic_dmalist, option_80) - 1usize];
    ["Offset of field: dmagic_dmalist::source_mb"]
        [::core::mem::offset_of!(dmagic_dmalist, source_mb) - 2usize];
    ["Offset of field: dmagic_dmalist::option_81"]
        [::core::mem::offset_of!(dmagic_dmalist, option_81) - 3usize];
    ["Offset of field: dmagic_dmalist::dest_mb"]
        [::core::mem::offset_of!(dmagic_dmalist, dest_mb) - 4usize];
    ["Offset of field: dmagic_dmalist::option_85"]
        [::core::mem::offset_of!(dmagic_dmalist, option_85) - 5usize];
    ["Offset of field: dmagic_dmalist::dest_skip"]
        [::core::mem::offset_of!(dmagic_dmalist, dest_skip) - 6usize];
    ["Offset of field: dmagic_dmalist::end_of_options"]
        [::core::mem::offset_of!(dmagic_dmalist, end_of_options) - 7usize];
    ["Offset of field: dmagic_dmalist::command"]
        [::core::mem::offset_of!(dmagic_dmalist, command) - 8usize];
    ["Offset of field: dmagic_dmalist::count"]
        [::core::mem::offset_of!(dmagic_dmalist, count) - 9usize];
    ["Offset of field: dmagic_dmalist::source_addr"]
        [::core::mem::offset_of!(dmagic_dmalist, source_addr) - 11usize];
    ["Offset of field: dmagic_dmalist::source_bank"]
        [::core::mem::offset_of!(dmagic_dmalist, source_bank) - 13usize];
    ["Offset of field: dmagic_dmalist::dest_addr"]
        [::core::mem::offset_of!(dmagic_dmalist, dest_addr) - 14usize];
    ["Offset of field: dmagic_dmalist::dest_bank"]
        [::core::mem::offset_of!(dmagic_dmalist, dest_bank) - 16usize];
    ["Offset of field: dmagic_dmalist::sub_cmd"]
        [::core::mem::offset_of!(dmagic_dmalist, sub_cmd) - 17usize];
    ["Offset of field: dmagic_dmalist::modulo"]
        [::core::mem::offset_of!(dmagic_dmalist, modulo) - 18usize];
};
extern "C" {
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of m65_tm"][::core::mem::size_of::<m65_tm>() - 11usize];
    ["Alignment of m65_tm"][::core::mem::align_of::<m65_tm>() - 1usize];
    ["Offset of field: m65_tm::tm_sec"][::core::mem::offset_of!(m65_tm, tm_sec) - 0usize];
    ["Offset of field: m65_tm::tm_min"][::core::mem::offset_of!(m65_tm, tm_min) - 1usize];
    ["Offset of field: m65_tm::tm_hour"][::core::mem::offset_of!(m65_tm, tm_hour) - 2usize];
    ["Offset of field: m65_tm::tm_mday"][::core::mem::offset_of!(m65_tm, tm_mday) - 3usize];
    ["Offset of field: m65_tm::tm_mon"][::core::mem::offset_of!(m65_tm, tm_mon) - 4usize];
    ["Offset of field: m65_tm::tm_year"][::core::mem::offset_of!(m65_tm, tm_year) - 5usize];
    ["Offset of field: m65_tm::tm_wday"][::core::mem::offset_of!(m65_tm, tm_wday) - 7usize];
    ["Offset of field: m65_tm::tm_yday"][::core::mem::offset_of!(m65_tm, tm_yday) - 8usize];
    ["Offset of field: m65_tm::tm_isdst"][::core::mem::offset_of!(m65_tm, tm_isdst) - 10usize];
};
extern "C" {
